...
use sp_runtime::{
	...
	traits::{
		self, BlakeTwo256, Block as BlockT, ConvertInto, NumberFor,
		OpaqueKeys,DispatchInfoOf,Dispatchable,PostDispatchInfoOf,
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substrate-pro-node"),
	impl_name: create_runtime_str!("substrate-pro-node"),
