...
//! Utilities to build a `TestClient` for `substrate-node-runtime`.
...
/// Call executor for `substrate-node-runtime` `TestClient`.
...
pub type Client = client::Client<
	...
	substrate_node_runtime::RuntimeApi,
>;

/// Transaction for substrate-node-runtime.
